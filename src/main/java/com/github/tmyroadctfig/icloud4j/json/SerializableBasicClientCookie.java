 ...
 *
 */
public class SerializableBasicClientCookie implements SetCookie, ClientCookie, Cloneable, Serializable, Comparable<SerializableBasicClientCookie> {

    private static final long serialVersionUID = -3869795591041535538L;

    public SerializableBasicClientCookie() {
    }
     ...
     */
    public SerializableBasicClientCookie(final String name, final String value) {
        this.name = name;
	...
	@Override
	public int compareTo(SerializableBasicClientCookie o) {
		return toString().compareTo(o.toString());
	}

    @Override
    public Object clone() throws CloneNotSupportedException {
        final SerializableBasicClientCookie clone = (SerializableBasicClientCookie)super.clone();
